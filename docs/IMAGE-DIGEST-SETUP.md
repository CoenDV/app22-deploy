...
image-name: ghcr.io/inholland-cloud-minor-2526/group1-videoservice
```

**For ChatService:**
```yaml
service-name: ChatService
image-name: ghcr.io/inholland-cloud-minor-2526/group1-chatservice
```

**For UserService:**
```yaml
service-name: UserService
image-name: ghcr.io/inholland-cloud-minor-2526/group1-userservice
```
...
docker pull ghcr.io/inholland-cloud-minor-2526/group1-videoservice:main

# Get the digest
docker inspect ghcr.io/inholland-cloud-minor-2526/group1-videoservice:main \
